                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'rqy9hta6' /* Link your phone number */,
                                                ),
                                                style:
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'zs9ki0wr' /* Enable security by connecting ... */,
                                                ),
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodySmall
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                labelText: FFLocalizations.of(context).getText(
                                  'sny0cm3m' /* City your were born */,
                                ),
                                labelStyle:
                                    FlutterFlowTheme.of(context).labelMedium,
                                hintText: FFLocalizations.of(context).getText(
                                  'xhba316a' /* City your were born */,
                                ),
                                hintStyle:
                                    FlutterFlowTheme.of(context).labelMedium,
                                enabledBorder: OutlineInputBorder(
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                labelText: FFLocalizations.of(context).getText(
                                  'a3zyngl3' /* # of people on your team */,
                                ),
                                labelStyle:
                                    FlutterFlowTheme.of(context).labelMedium,
                                hintText: FFLocalizations.of(context).getText(
                                  '9hofgl1f' /* # of people on your team */,
                                ),
                                hintStyle:
                                    FlutterFlowTheme.of(context).labelMedium,
                                enabledBorder: OutlineInputBorder(
