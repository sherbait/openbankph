...
import 'bank_product_info_model.dart';
export 'bank_product_info_model.dart';

class BankProductInfoWidget extends StatefulWidget {
  const BankProductInfoWidget({
    super.key,
  ...
  @override
  _BankProductInfoWidgetState createState() => _BankProductInfoWidgetState();
}

class _BankProductInfoWidgetState extends State<BankProductInfoWidget> {
  late BankProductInfoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BankProductInfoModel());
                                          ...
                                          child: Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 0.0, 6.0, 0.0),
                                            child: Text(
                                              functions.currencyOrPercentage(
                                                  getJsonField(
                                                productAttributesItem,
                                                r'''$.type''',
                                              ).toString())!,
