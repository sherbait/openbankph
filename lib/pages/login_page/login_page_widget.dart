                                ...
                                children: [
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      _model.directRequestTokenResponse =
                                          await OpenBankProjectGroup
                                              .authTokenCall
                                              .call();
                                      if ((_model.directRequestTokenResponse
                                              ?.succeeded ??
                                          true)) {
                                        FFAppState().token =
                                            OpenBankProjectGroup.authTokenCall
                                                .authToken(
                                                  (_model.directRequestTokenResponse
                                                          ?.jsonBody ??
                                                      ''),
                                        ...
                                        ScaffoldMessenger.of(context)
                                          ...
                                          SnackBar(
                                            content: Text(
                                              'Authorization Error - please submit a bug report',
                                              style:
                              ...
                              Row(
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      context.pushNamed('registerAccountPage');
                                    },
                                    child: Container(
