...
import 'schema/account_list_record.dart';
...
export 'schema/account_list_record.dart';
...
/// Functions to query AccountListRecords (as a Stream and as a Future).
Future<int> queryAccountListRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      AccountListRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<AccountListRecord>> queryAccountListRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      AccountListRecord.collection,
      AccountListRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<AccountListRecord>> queryAccountListRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
